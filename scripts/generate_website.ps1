...
function New-SectionHTML {
    ...
    foreach ($line in $lines) {
        ...
        elseif ($trimmed -match '\[IMAGE:\s*(.*?)\]') {
            ...
            $paragraphs += "<div class='image-container'><img src='${ImageDepth}images/$imageFile' alt='Book Image' class='book-image'></div>"
        }
...
<head>
    ...
    <link rel="stylesheet" href="${assetDepth}assets/css/styles.css">
</head>
<!-- END HEAD -->
<body>
    ...
    <script src="${assetDepth}assets/js/sidebar.js"></script>
    <script src="${assetDepth}assets/js/search.js"></script>
    <script src="${assetDepth}assets/js/language_toggle.js"></script>
    <script src="${assetDepth}assets/js/glossary_tooltip.js"></script>
    <script src="${assetDepth}assets/js/audio.js"></script>
    <script src="${assetDepth}assets/js/bookmarks.js"></script>
    <script src="${assetDepth}assets/js/breadcrumb_mobile.js"></script>
    <script>
        // Theme Toggle
...
$sidebarContent | Set-Content (Join-Path $websitePath "templates/includes/sidebar_content.html") -Encoding UTF8
...
$bibContentPath = Join-Path $websitePath "templates/includes/bibliography_content.html"
...
# Generate Glossary
$glossContentPath = Join-Path $websitePath "templates/includes/glossary_content.html"
